...
public class GoalModel implements Serializable {
    ...
    public GoalModel(String goalName, Uri photoThumb) {
    ...
    public GoalModel(String foodName/*, Uri photoThumb, Double servingQuantity, String servingUnit,
